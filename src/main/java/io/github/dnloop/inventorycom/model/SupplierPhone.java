 ...
 * <p>
 * Entity used to represent supplier's phones on the database.
 * </p>
 */
@Entity
...
public class SupplierPhone {
    private Integer id;
    @Phone(message = "{supplier.phone.required}")
    ...
    /**
     * This method must be called after successful validation of phoneNumber
     */
